...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3 d-md-block bg-dark" href="#">HOTEL DEL LUNA</a>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <?php
          ...
          <div class="dashboard">
            ...
            <p class="lead">Halaman ini adalah halaman pengelolaan aplikasi reservasi Hotel DEL LUNA</p>
          </div>
        <?php } else {
